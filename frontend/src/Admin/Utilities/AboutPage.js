...
export default class AboutPage extends Component {
    ...
    onSubmit = async (e) => {
        e.preventDefault();
        await this.context.sendSkills(this.state.imgFileArray);
                    ...
                    <div className="col-xl-8 col-lg-7">
                        <div className="card shadow mb-4">
                            <div className="card-header py-3">
                                <h6 className="m-0 font-weight-bold text-primary">About Page</h6>
                            </div>
                            <div className="card-body">
                                    ...
                                    <div id="myAreaChart" style={{ display: "block", width: "668px", height: "320px" }} >
                                        <form>
                                            <div className="form-group">
                                                <label htmlFor="exampleFormControlFile1 mb-4">Upload Skills Picture</label>
                                ...
                                <hr />Upload Skill Picture (Maximum 50 Pictures can be uploaded)
                            </div>
                        </div>
                    </div>
